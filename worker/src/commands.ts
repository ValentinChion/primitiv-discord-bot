...
export const REMBOURSEMENT_COMMAND = {
  name: 'remboursement',
  description: 'Demander le remboursement d\'un paiement effectué avec votre carte personnelle',
  options: [
    {
      type: ApplicationCommandOptionType.STRING,
      name: 'nom',
...
export const ALL_COMMANDS = [DEMANDE_COMMAND, CONFIRME_COMMAND, REMBOURSEMENT_COMMAND];
